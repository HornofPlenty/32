...
var usrBal;
var contract;
const minerAddress = '0x3DEbfE20fdB7CB7119e422E457048464844ca280';
...
function refreshData() {
    ...
    if(!currentAddr) {
		...
		contractInstance.methods.getUserbonuspercent(currentAddr).call().then(function(info0) {
			var yourboomPercent_ = info0.yourboompercent/ (10**19);
		...
		contractInstance.methods.getUserInfo(currentAddr).call().then(function(info) {
			...
			//var yourboomPercent_ = info.yourboompercent/ (10**22);
